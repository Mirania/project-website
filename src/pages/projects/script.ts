...
projectCardBuilder.addLeftCard(
...
projectCardBuilder.addRightCard(
...
projectCardBuilder.addRightCard(
    ...
    `A project conducted during the final semester of the Bachelor's degree.${paragraph()} ` +
    ...
    `sessions.${paragraph()}${inlineSmall("You can unmute and fullscreen the video if you wish to.")}`,
    true,
    true
);
