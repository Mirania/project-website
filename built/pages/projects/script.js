...
const galleries = [];
const entries = [];
addLeftCard(["projects/assets/1.mp4", "projects/assets/2.mp4", "projects/assets/3.mp4"], "Pokémon Unity", `A fully-fledged Pokémon game with a scale and complexity comparable to old school ` +
...
addRightCard("projects/assets/marble.mp4", "Marble", `A physics-based platforming game that will be developed using the ${inlineHref("Unity Engine", "https://unity.com/")}. ` +
...
addLeftCard("projects/assets/jscrambler.png", "Improvement of a JavaScript Obfuscator", `Internship at ${inlineHref("Jscrambler", "https://jscrambler.com/")}, a company that develops security ` +
...
addRightCard("projects/assets/collab.mp4", "Multi-user Image Editor", `A project conducted during the final semester of the Bachelor's degree.${inlineBr()}${inlineBr()} ` +
    ...
    `sessions.${inlineBr()}${inlineBr()}${inlineSmall("You can unmute and fullscreen the video if you wish to.")}`, true, true);
animateEntries();
