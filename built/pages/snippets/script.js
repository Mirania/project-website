...
snippetCardBuilder.addLeftCard(["snippets/assets/firebase.png", "snippets/assets/firebase-java.png"], "Simple Firebase API", `${langs("Java, JavaScript and TypeScript")} ` +
    ...
    `a user's data into something as simple as ${code("db.get(\"users/1\")")} .`, false, true);
snippetCardBuilder.addRightCard("snippets/assets/rest.png", "Rest API Consumer", `${langs("Java")} ` +
    ...
    `as POST requests into something trivial like ${code("reply = post(url, data)")} .`, false, true);
snippetCardBuilder.addLeftCard("snippets/assets/autocorrect.png", "Autocorrect", `${langs("JavaScript and TypeScript")} ` +
    ...
    `customizable and not bound to any language.`, false, true);
snippetCardBuilder.addRightCard("snippets/assets/pyarray.png", "Pythonic JavaScript Arrays", `${langs("JavaScript and TypeScript")} ` +
    ...
    `(${code("list[\"1:3\"]")}).`, false, true);
snippetCardBuilder.addLeftCard("snippets/assets/colors.png", "Console Coloring", `${langs("JavaScript and TypeScript")} ` +
    ...
    `that additionally lets users create and store colored strings.`, false, true);
snippetCardBuilder.addRightCard("snippets/assets/unchecker.png", "Exception Unchecker", `${langs("Java")} ` +
    ...
    `that would be thrown into an unchecked version of it, removing the need for try-catch operations.`, false, true);
