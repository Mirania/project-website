 ...
 */
function handleRampVelocity(collision) {
 ...
 */
function applyMomentum(velocity, collision) {
 ...
 */
function detectCollisions(player, stage) {
    ...
    for (let i = 0; i < stage.platforms.length; i++) {
        ...
        if (collisionResults.length > 0) {
            if (collisionResults[0].distance <= 0.2)
                player.model.position.y += 0.025;
 ...
 */
function snapToAngle(targetAngle) {
 ...
 */
function movePlayer(adjustedVelocity) {
