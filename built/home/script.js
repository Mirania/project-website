...
function homeInit() {
    ...
    const bloomPass = new UnrealBloomPass(new THREE.Vector2(window.innerWidth, window.innerHeight), 0.2, 0.5, 0);
...
function fadeObjectsIn(earth, clouds, cloudsTargetOpacity) {
